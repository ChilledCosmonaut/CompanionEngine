...
| Final Title | Attack on SpaceStation Asteroid                                                     |
...
Attack on SpaceStation Asteroid is a Space-shooter game written in C++ that allows the Player to fight of waves of enemies on a dynaimc physics-based battlefield.

Lure your enemies into the asteroid belt surrounding the station or get trapped in it? Prove that you're cappable of defending the station!
